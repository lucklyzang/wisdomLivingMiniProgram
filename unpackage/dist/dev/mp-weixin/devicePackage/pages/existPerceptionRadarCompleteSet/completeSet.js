...
var _completeSet = _interopRequireDefault(__webpack_require__(/*! ./devicePackage/pages/existPerceptionRadarCompleteSet/completeSet.vue */ 391));
// @ts-ignore
...
/* harmony import */ var _completeSet_vue_vue_type_template_id_66cc0951___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./completeSet.vue?vue&type=template&id=66cc0951& */ 392);
/* harmony import */ var _completeSet_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./completeSet.vue?vue&type=script&lang=js& */ 394);
...
/* harmony import */ var _completeSet_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./completeSet.vue?vue&type=style&index=0&lang=scss& */ 396);
...
var _default = {
  ...
  onShow: function onShow() {
    ...
    uni.$on('update', function (object) {
      // 获取雷达设置
      _this.getRadarSet(_this.beforeAddExistPerceptionRadarCompleteSet.deviceId);
      ...
      (0, _device.getExistAlarmSettings)({
        ...
        if (res && res.data.code == 0) {
          ...
          if (res.data.data.stop) {
            _this3.stop = true;
            _this3.stopTime = res.data.data.stopTime;
            _this3.alarmRangeValueList.push('人员滞留报警');
          } else {
            _this3.stop = false;
          }
          ;
          ...
          // 回显保存的报警范围设置信息
          if (_this3.beforeAddExistPerceptionRadarCompleteSet['isSaveAlarmRanageInfo']) {
...
},[[390,"common/runtime","common/vendor","devicePackage/common/vendor"]]]);
