...
var _index = _interopRequireDefault(__webpack_require__(/*! ./devicePackage/pages/device/index/index.vue */ 220));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/* harmony import */ var _index_vue_vue_type_template_id_b5c74918___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=b5c74918& */ 221);
...
try {
  components = {
    ...
    xflSelect: function() {
      return __webpack_require__.e(/*! import() | components/xfl-select/xfl-select */ "components/xfl-select/xfl-select").then(__webpack_require__.bind(null, /*! @/components/xfl-select/xfl-select.vue */ 582))
    }
  }
} catch (e) {
  if (
...

{
  ...
  data: function data() {
    return {
      ...
      deviceInformIconPng: __webpack_require__(/*! @/static/img/device-inform-icon.png */ 225),
      systemInformIconPng: __webpack_require__(/*! @/static/img/system-inform-icon.png */ 226),
      familyMemberList: [
      {
        id: 1,
        value: '张三的家' },
...
},[[219,"common/runtime","common/vendor","devicePackage/common/vendor"]]]);
