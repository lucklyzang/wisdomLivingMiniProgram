...
var _index = _interopRequireDefault(__webpack_require__(/*! ./devicePackage/pages/device/index/index.vue */ 244));
// @ts-ignore
...
/* harmony import */ var _index_vue_vue_type_template_id_b5c74918___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=b5c74918& */ 245);
...
var _default = {
  ...
  data: function data() {
    return {
      ...
      deviceInformIconPng: __webpack_require__(/*! @/static/img/device-inform-icon.png */ 249),
      systemInformIconPng: __webpack_require__(/*! @/static/img/system-inform-icon.png */ 250),
      familyMemberList: []
    };
  },
    ...
    queryUserFamilyList: function queryUserFamilyList() {
      ...
      (0, _user.getUserFamilyList)().then(function (res) {
        if (res && res.data.code == 0) {
          ...
          ;
          if (_this.familyId) {
            _this.initValue = _this.familyId;
          } else {
            _this.initValue = _this.familyMemberList[0]['id'];
          }
          ;
        } else {
