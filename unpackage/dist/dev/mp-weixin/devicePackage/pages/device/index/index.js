...

{
  ...
  data: function data() {
    return {
      ...
      deviceInformIconPng: __webpack_require__(/*! @/static/img/device-inform-icon.png */ 114),
      systemInformIconPng: __webpack_require__(/*! @/static/img/system-inform-icon.png */ 115),
      familyMemberList: [
      {
        id: 1,
        value: '张三的家' },
